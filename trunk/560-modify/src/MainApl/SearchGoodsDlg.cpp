...
IMPLEMENT_DYNAMIC(CSearchGoodsDlg, CDialog)

CSearchGoodsDlg::CSearchGoodsDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CSearchGoodsDlg::IDD, pParent)
    , strStartProvince(_T(""))
    , strStartCity(_T(""))
    , strStartCounty(_T(""))
    , strEndProvince(_T(""))
...
CSearchGoodsDlg::~CSearchGoodsDlg()
{
}
    
//
void CSearchGoodsDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CSearchGoodsDlg, CDialog)
    ON_CBN_SELCHANGE(IDC_START_PROVINCE, &CSearchGoodsDlg::OnCbnSelchangeStartProvince)
    ON_CBN_SELCHANGE(IDC_START_CITY, &CSearchGoodsDlg::OnCbnSelchangeStartCity)
    ON_CBN_SELCHANGE(IDC_END_PROVINCE, &CSearchGoodsDlg::OnCbnSelchangeEndProvince)
    ON_CBN_SELCHANGE(IDC_END_CITY, &CSearchGoodsDlg::OnCbnSelchangeEndCity)
    ON_BN_CLICKED(IDOK, &CSearchGoodsDlg::OnBnClickedOk)
END_MESSAGE_MAP()


// CSearchGoodsDlg 消息处理程序

BOOL CSearchGoodsDlg::OnInitDialog()
{
...
// 初始化出发地
int CSearchGoodsDlg::initStartPoint()
{
    if (myCR == NULL) {
        return -1;
    }
...
// 初始化到达地
int CSearchGoodsDlg::initEndPoint()
{
    if (myCR == NULL) {
        return -1;
    }
...
// 响应出发省列表框点击消息
void CSearchGoodsDlg::OnCbnSelchangeStartProvince()
{
    // TODO: 在此添加控件通知处理程序代码
...
// 响应出发市列表框点击消息
void CSearchGoodsDlg::OnCbnSelchangeStartCity()
{
    // TODO: 在此添加控件通知处理程序代码
...
// 响应到达省列表框点击消息
void CSearchGoodsDlg::OnCbnSelchangeEndProvince()
{
    // TODO: 在此添加控件通知处理程序代码
...
// 响应到达市列表框点击消息
void CSearchGoodsDlg::OnCbnSelchangeEndCity()
{
    // TODO: 在此添加控件通知处理程序代码
...
void CSearchGoodsDlg::OnBnClickedOk()
{
    // TODO: 在此添加控件通知处理程序代码
    UpdateData();
    bool ifOK = true;
