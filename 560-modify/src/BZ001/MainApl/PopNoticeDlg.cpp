...
BOOL CPopNoticeDlg::OnInitDialog()
{
    ...
    // 设置字体
    m_scroller.SetFont("黑体", 11, FW_NORMAL);
    // 设置文字颜色
    //m_scroller.SetFgColor(RGB(0, 0, 255));
	m_scroller.SetFgColor(RGB(29, 55, 72));
    // 设置信息内容
	...
	m_HyperLink1.SetBackgroundColor(RGB(255,255,255));
	...
	m_hyperAG.SetBackgroundColor(RGB(255,255,255));
